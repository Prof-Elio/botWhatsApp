...
class BotWhatsapp:
    def __init__(self):
        self.mensagem = "Bot Elio!"
        self.mensagemPersonalizada = "Olá, sou o bot do Prof. Elio! Nome: Elio E-mail= prof.elio@uniuv.edu.br Telefone: 991491848"
        self.grupos = ["Recados"]
    ...
    def MandarMensagens(self):
        #<span dir="auto" title="Algoritmos e estruturas I" class="_35k-1 _1adfa _3-8er">Algoritmos e estruturas I</span>
    ...
    def LerMensagem(self):
        ...
        while(statusBot):
            ...
            retorno = self.caminho.find_element_by_xpath('/html/body/div[1]/div/div/div[4]/div/div[3]/div/div/div[3]').text
            listaRetorno = retorno.splitlines()

            if listaRetorno[len(listaRetorno)-2] == "!BotElio":
